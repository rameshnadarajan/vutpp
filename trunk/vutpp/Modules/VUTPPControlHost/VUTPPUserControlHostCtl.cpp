// VUTPPUserControlHostCtl.cpp : Implementation of CVUTPPUserControlHostCtl
#include "stdafx.h"
...
// CActiveXShimCtl
class ATL_NO_VTABLE CVUTPPUserControlHostCtl : 
	public IDispatchImpl<IVUTPPUserControlHostCtlCtl, &IID_IVUTPPUserControlHostCtlCtl, &LIBID_VUTPPUserControlHostLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public CComObjectRootEx<CComSingleThreadModel>,
	public IPersistStreamInitImpl<CVUTPPUserControlHostCtl>,
	public IOleControlImpl<CVUTPPUserControlHostCtl>,
	public IOleObjectImpl<CVUTPPUserControlHostCtl>,
	public IOleInPlaceActiveObjectImpl<CVUTPPUserControlHostCtl>,
	public IViewObjectExImpl<CVUTPPUserControlHostCtl>,
	public IOleInPlaceObjectWindowlessImpl<CVUTPPUserControlHostCtl>,
	public ISupportErrorInfo,
	public IPersistStorageImpl<CVUTPPUserControlHostCtl>,
	public ISpecifyPropertyPagesImpl<CVUTPPUserControlHostCtl>,
	public IQuickActivateImpl<CVUTPPUserControlHostCtl>,
	public IDataObjectImpl<CVUTPPUserControlHostCtl>,
	public CComCompositeControl<CVUTPPUserControlHostCtl>,
	public IProvideClassInfo2Impl<&CLSID_VUTPPUserControlHostCtl, NULL, &LIBID_VUTPPUserControlHostLib>,
	public CComCoClass<CVUTPPUserControlHostCtl, &CLSID_VUTPPUserControlHostCtl>
{
public:
	...
	BEGIN_COM_MAP(CVUTPPUserControlHostCtl)
		COM_INTERFACE_ENTRY(IVUTPPUserControlHostCtlCtl)
	...
	BEGIN_PROP_MAP(CVUTPPUserControlHostCtl)
	END_PROP_MAP()

	BEGIN_MSG_MAP(CVUTPPUserControlHostCtl)
		MESSAGE_HANDLER(WM_ERASEBKGND, OnEraseBackground)
		MESSAGE_HANDLER(WM_SIZE, OnSize)
		MESSAGE_HANDLER(WM_SHOWWINDOW, OnShow) 
		CHAIN_MSG_MAP(CComCompositeControl<CVUTPPUserControlHostCtl>)
	END_MSG_MAP()

	//BEGIN_SINK_MAP(CVUTPPUserControlHostCtl)
	//END_SINK_MAP()

	STDMETHOD(InterfaceSupportsErrorInfo)(REFIID riid)
	{
		if(InlineIsEqualGUID(IID_IVUTPPUserControlHostCtlCtl, riid))
			return S_OK;
		return S_FALSE;
	}
	...
	BOOL PreTranslateAccelerator(LPMSG pMsg, HRESULT& hRet)
	{
		...
		return CComCompositeControl<CVUTPPUserControlHostCtl>::PreTranslateAccelerator(pMsg, hRet);
	}
	...
	STDMETHOD(TranslateAccelerator)(LPMSG pMsg)
	{
		...
		if(m_pUserControl && m_pUserControl->QueryInterface(__uuidof(IOleInPlaceActiveObject), (LPVOID*)&pIPAO) == S_OK && (pIPAO.p))
			if(pIPAO->TranslateAccelerator(pMsg) == S_OK) 
				return S_OK;
		return IOleInPlaceActiveObjectImpl<CVUTPPUserControlHostCtl>::TranslateAccelerator(pMsg);
	}
};

// this line generates the control's self-registration and instantiation code
OBJECT_ENTRY_AUTO(__uuidof(VUTPPUserControlHostCtl), CVUTPPUserControlHostCtl)
